...
<div class="max-w-lg">
  <a href="<?= BASE_URL ?>/envios/" class="inline-flex items-center gap-1 text-sm text-gray-500 hover:text-gray-700 mb-4">
  ...
  <form method="POST" class="bg-white rounded-xl border border-gray-200 shadow-sm p-5 space-y-4">
    ...
    <div class="flex justify-end gap-3 pt-2">
      <a href="<?= BASE_URL ?>/envios/" class="text-sm text-gray-500 px-4 py-2">Cancelar</a>
